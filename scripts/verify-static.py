...
need("web/settings/app.js", "output.paced_typing_enabled", "output.typing_speed_wpm", "output.linux_delivery_cycle", 'label: "Speed"', "min: 50", "max: 450", "range-value", '"installed downloaded local"', '"recommended"', '"selected"', 'more.textContent = "View more"', "visibleModelLimit += 8", 'class="group-reset"', 'Reset group', 'Refresh tools', 'Search tools and delivery methods', 'Smart Paste', 'Advanced paste shortcuts', 'paste_shift_insert', 'delivery-picker-cycle', 'e.kind === "configuration_reloaded"', 'refreshState(true)', 'className = "shortcut-refresh"', 'reset to defaults. Save to apply it.')

...
Type: files; Name: "{app}\runtime\AutoHotkey64.exe"
...
[Icons]
Name: "{group}\simple-stt"; Filename: "{app}\runtime\simple-stt.exe"; WorkingDir: "{app}\runtime"
Name: "{autodesktop}\simple-stt"; Filename: "{app}\runtime\simple-stt.exe"; WorkingDir: "{app}\runtime"; Tasks: desktopicon
Name: "{userstartup}\simple-stt"; Filename: "{app}\runtime\simple-stt.exe"; WorkingDir: "{app}\runtime"; Tasks: startup
...
Filename: "{app}\runtime\simple-stt.exe"; Description: "Launch simple-stt"; Flags: postinstall nowait skipifsilent
